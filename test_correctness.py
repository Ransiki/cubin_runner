...
PHASE1_SCRIPT = os.path.join(os.path.dirname(__file__), "_phase1_quantize.py")
PHASE2_SCRIPT = os.path.join(os.path.dirname(__file__), "_phase2_cubin_run.py")
...
if __name__ == "__main__":
    print("=" * 70)
    print("  NvFP4 MOE Cubin Correctness Test")
